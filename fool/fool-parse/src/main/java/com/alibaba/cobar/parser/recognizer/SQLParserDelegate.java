...
public final class SQLParserDelegate {
    ...
    private static SQLStatement parseOneSql(MySQLLexer lexer, MySQLExprParser exprParser) throws SQLSyntaxErrorException {
    ...
    public static List<SQLStatement> parse(String sql, MySQLLexer lexer, String charset) throws SQLSyntaxErrorException {
        try {
            ...
            while(lexer.token() != MySQLToken.EOF) {
                sqlStatementList.add(parseOneSql(lexer, exprParser));
    ...
    public static List<SQLStatement> parse(String sql, String charset) throws SQLSyntaxErrorException {
        return parse(sql, new MySQLLexer(sql), charset);
    }

    public static List<SQLStatement> parse(String sql) throws SQLSyntaxErrorException {
