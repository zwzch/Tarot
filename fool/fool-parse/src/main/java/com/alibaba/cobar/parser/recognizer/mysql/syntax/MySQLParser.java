...
public abstract class MySQLParser {
    ...
    protected Limit limit() throws SQLSyntaxErrorException {
        ...
        case LITERAL_NUM_PURE_DIGIT:
            ...
            case IDENTIFIER:
                if ("OFFSET".equals(lexer.stringValueUppercase())) {
                    ...
                    case LITERAL_NUM_PURE_DIGIT:
                        Number num2 = lexer.integerValue();
                        lexer.nextToken();
                        Limit limit = new Limit(num2, num1);
                        limit.setHaveOffset(true);
                        return limit;
                    case QUESTION_MARK:
                        paramIndex1 = lexer.paramIndex();
                        lexer.nextToken();
                        Limit lm = new Limit(createParam(paramIndex1), num1);
                        lm.setHaveOffset(true);
                        return lm;
                    default:
                        throw err("expect digit or ? after , for limit");
                    }
            ...
            return new Limit((Integer)null, num1);
        case QUESTION_MARK:
            paramIndex1 = lexer.paramIndex();
            switch (lexer.nextToken()) {
            case PUNC_COMMA:
            ...
            case IDENTIFIER:
                if ("OFFSET".equals(lexer.stringValueUppercase())) {
                    ...
                    case LITERAL_NUM_PURE_DIGIT:
                        num1 = lexer.integerValue();
                        lexer.nextToken();
                        Limit limit = new Limit(num1, createParam(paramIndex1));
                        limit.setHaveOffset(true);
                        return limit;
                    case QUESTION_MARK:
                        paramIndex2 = lexer.paramIndex();
                        lexer.nextToken();
                        Limit lm = new Limit(createParam(paramIndex2), createParam(paramIndex1));
                        lm.setHaveOffset(true);
                        return lm;
                    default:
                        throw err("expect digit or ? after , for limit");
            ...
            return new Limit((Integer)null, createParam(paramIndex1));
        default:
